...
Use this skill when the user asks for `$aof-add-uat <short session description> [in <group/path>] [accepting NN[,NN…]]   (accepting optional - defaults to the delivered span)`, or asks to run the AOF `aof:add-uat` procedure in Codex.
