...
Use this skill when the user asks for `$aof-add-milestone <short milestone description> [in <group/path>]`, or asks to run the AOF `aof:add-milestone` procedure in Codex.
