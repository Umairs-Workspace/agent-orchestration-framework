...
Use this skill when the user asks for `$aof-autonomous <range - NN-MM or NN> [--ship] [--max-attempts N] [--solo]`, or asks to run the AOF `aof:autonomous` procedure in Codex.
