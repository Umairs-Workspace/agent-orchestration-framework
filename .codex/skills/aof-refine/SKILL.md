...
Use this skill when the user asks for `$aof-refine <item ref - NN or slug> [--autonomous] [--solo | --orchestrated]`, or asks to run the AOF `aof:refine` procedure in Codex.
